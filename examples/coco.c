...
{
    //char *train_images = "/home/shiroe/data/voc/test/train.txt";
    //char *train_images = "/home/shiroe/data/coco/train.txt";
...
void validate_coco(char *cfg, char *weights)
{
    ...
    //list *plist = get_paths("/home/shiroe/data/people-art/test.txt");
    //list *plist = get_paths("/home/shiroe/data/voc/test/2007_test.txt");
    char **paths = (char **)list_to_array(plist);
