...
{
#ifdef GPU
    //char *train_images = "/home/shiroe/data/coco/trainvalno5k.txt";
    char *train_images = "/home/shiroe/data/imagenet/imagenet1k.train.list";
    //char *style_images = "/home/shiroe/data/coco/trainvalno5k.txt";
    char *style_images = "/home/shiroe/zelda.txt";
    char *backup_directory = "/home/shiroe/backup/";
    srand(time(0));
...
{
#ifdef GPU
    //char *train_images = "/home/shiroe/data/coco/train1.txt";
    //char *train_images = "/home/shiroe/data/coco/trainvalno5k.txt";
    char *train_images = "/home/shiroe/data/imagenet/imagenet1k.train.list";
    char *backup_directory = "/home/shiroe/backup/";
    srand(time(0));
...
void run_lsd(int argc, char **argv)
{
    ...
    char *file = find_char_arg(argc, argv, "-file", "/home/shiroe/data/imagenet/imagenet1k.train.list");
